...
static const char* ChatService_method_names[] = {
  ...
  "/message.ChatService/NotifyFileChatMsg",
};
...
ChatService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel)
  ...
  , rpcmethod_NotifyFileChatMsg_(ChatService_method_names[5], ::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  {}
...
::grpc::Status ChatService::Stub::NotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::message::FileChatMsgRsp* response) {
  return ::grpc::internal::BlockingUnaryCall< ::message::FileChatMsgReq, ::message::FileChatMsgRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_NotifyFileChatMsg_, context, request, response);
}

void ChatService::Stub::experimental_async::NotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq* request, ::message::FileChatMsgRsp* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::message::FileChatMsgReq, ::message::FileChatMsgRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_NotifyFileChatMsg_, context, request, response, std::move(f));
}

void ChatService::Stub::experimental_async::NotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq* request, ::message::FileChatMsgRsp* response, ::grpc::experimental::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_NotifyFileChatMsg_, context, request, response, reactor);
}

::grpc::ClientAsyncResponseReader< ::message::FileChatMsgRsp>* ChatService::Stub::PrepareAsyncNotifyFileChatMsgRaw(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::message::FileChatMsgRsp, ::message::FileChatMsgReq, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_NotifyFileChatMsg_, context, request);
}

::grpc::ClientAsyncResponseReader< ::message::FileChatMsgRsp>* ChatService::Stub::AsyncNotifyFileChatMsgRaw(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncNotifyFileChatMsgRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
ChatService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< ChatService::Service, ::message::FileChatMsgReq, ::message::FileChatMsgRsp, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](ChatService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::message::FileChatMsgReq* req,
             ::message::FileChatMsgRsp* resp) {
               return service->NotifyFileChatMsg(ctx, req, resp);
             }, this)));
}
...
::grpc::Status ChatService::Service::NotifyFileChatMsg(::grpc::ServerContext* context, const ::message::FileChatMsgReq* request, ::message::FileChatMsgRsp* response) {
  (void) context;
  (void) request;
  (void) response;
  return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
