 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status NotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::message::FileChatMsgRsp* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::FileChatMsgRsp>> AsyncNotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::FileChatMsgRsp>>(AsyncNotifyFileChatMsgRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::FileChatMsgRsp>> PrepareAsyncNotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::message::FileChatMsgRsp>>(PrepareAsyncNotifyFileChatMsgRaw(context, request, cq));
    }
    class experimental_async_interface {
     public:
      virtual ~experimental_async_interface() {}
      ...
      #endif
      virtual void NotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq* request, ::message::FileChatMsgRsp* response, std::function<void(::grpc::Status)>) = 0;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void NotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq* request, ::message::FileChatMsgRsp* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void NotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq* request, ::message::FileChatMsgRsp* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
    };
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    typedef class experimental_async_interface async_interface;
  ...
  private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::message::FileChatMsgRsp>* AsyncNotifyFileChatMsgRaw(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::message::FileChatMsgRsp>* PrepareAsyncNotifyFileChatMsgRaw(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel);
    ...
    ::grpc::Status NotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::message::FileChatMsgRsp* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::FileChatMsgRsp>> AsyncNotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::FileChatMsgRsp>>(AsyncNotifyFileChatMsgRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::FileChatMsgRsp>> PrepareAsyncNotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::message::FileChatMsgRsp>>(PrepareAsyncNotifyFileChatMsgRaw(context, request, cq));
    }
    class experimental_async final :
      public StubInterface::experimental_async_interface {
     public:
      ...
      #endif
      void NotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq* request, ::message::FileChatMsgRsp* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void NotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq* request, ::message::FileChatMsgRsp* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void NotifyFileChatMsg(::grpc::ClientContext* context, const ::message::FileChatMsgReq* request, ::message::FileChatMsgRsp* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
     private:
      friend class Stub;
      explicit experimental_async(Stub* stub): stub_(stub) { }
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::message::FileChatMsgRsp>* AsyncNotifyFileChatMsgRaw(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::message::FileChatMsgRsp>* PrepareAsyncNotifyFileChatMsgRaw(::grpc::ClientContext* context, const ::message::FileChatMsgReq& request, ::grpc::CompletionQueue* cq) override;
    ...
    const ::grpc::internal::RpcMethod rpcmethod_NotifyFileChatMsg_;
  };
  static std::unique_ptr<Stub> NewStub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options = ::grpc::StubOptions());
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    virtual ::grpc::Status NotifyFileChatMsg(::grpc::ServerContext* context, const ::message::FileChatMsgReq* request, ::message::FileChatMsgRsp* response);
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithAsyncMethod_NotifyFileChatMsg : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_NotifyFileChatMsg() {
      ::grpc::Service::MarkMethodAsync(5);
    }
    ~WithAsyncMethod_NotifyFileChatMsg() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyFileChatMsg(::grpc::ServerContext* /*context*/, const ::message::FileChatMsgReq* /*request*/, ::message::FileChatMsgRsp* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestNotifyFileChatMsg(::grpc::ServerContext* context, ::message::FileChatMsgReq* request, ::grpc::ServerAsyncResponseWriter< ::message::FileChatMsgRsp>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(5, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_NotifyAddFriend<WithAsyncMethod_RplyAddFriend<WithAsyncMethod_SendChatMsg<WithAsyncMethod_NotifyAuthFriend<WithAsyncMethod_NotifyTextChatMsg<WithAsyncMethod_NotifyFileChatMsg<Service > > > > > > AsyncService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_NotifyFileChatMsg : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_NotifyFileChatMsg() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(5,
          new ::grpc::internal::CallbackUnaryHandler< ::message::FileChatMsgReq, ::message::FileChatMsgRsp>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
                   ::grpc::CallbackServerContext*
    #else
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::message::FileChatMsgReq* request, ::message::FileChatMsgRsp* response) { return this->NotifyFileChatMsg(context, request, response); }));}
    void SetMessageAllocatorFor_NotifyFileChatMsg(
        ::grpc::experimental::MessageAllocator< ::message::FileChatMsgReq, ::message::FileChatMsgRsp>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(5);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(5);
    #endif
      static_cast<::grpc::internal::CallbackUnaryHandler< ::message::FileChatMsgReq, ::message::FileChatMsgRsp>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_NotifyFileChatMsg() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyFileChatMsg(::grpc::ServerContext* /*context*/, const ::message::FileChatMsgReq* /*request*/, ::message::FileChatMsgRsp* /*response*/) override {
    ...
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    virtual ::grpc::ServerUnaryReactor* NotifyFileChatMsg(
      ::grpc::CallbackServerContext* /*context*/, const ::message::FileChatMsgReq* /*request*/, ::message::FileChatMsgRsp* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* NotifyFileChatMsg(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::message::FileChatMsgReq* /*request*/, ::message::FileChatMsgRsp* /*response*/)
    #endif
      { return nullptr; }
  };
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_NotifyAddFriend<ExperimentalWithCallbackMethod_RplyAddFriend<ExperimentalWithCallbackMethod_SendChatMsg<ExperimentalWithCallbackMethod_NotifyAuthFriend<ExperimentalWithCallbackMethod_NotifyTextChatMsg<ExperimentalWithCallbackMethod_NotifyFileChatMsg<Service > > > > > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_NotifyAddFriend<ExperimentalWithCallbackMethod_RplyAddFriend<ExperimentalWithCallbackMethod_SendChatMsg<ExperimentalWithCallbackMethod_NotifyAuthFriend<ExperimentalWithCallbackMethod_NotifyTextChatMsg<ExperimentalWithCallbackMethod_NotifyFileChatMsg<Service > > > > > > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithGenericMethod_NotifyFileChatMsg : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_NotifyFileChatMsg() {
      ::grpc::Service::MarkMethodGeneric(5);
    }
    ~WithGenericMethod_NotifyFileChatMsg() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyFileChatMsg(::grpc::ServerContext* /*context*/, const ::message::FileChatMsgReq* /*request*/, ::message::FileChatMsgRsp* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_NotifyFileChatMsg : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_NotifyFileChatMsg() {
      ::grpc::Service::MarkMethodRaw(5);
    }
    ~WithRawMethod_NotifyFileChatMsg() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyFileChatMsg(::grpc::ServerContext* /*context*/, const ::message::FileChatMsgReq* /*request*/, ::message::FileChatMsgRsp* /*response*/) override {
    ...
    void RequestNotifyFileChatMsg(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(5, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_NotifyFileChatMsg : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_NotifyFileChatMsg() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(5,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->NotifyFileChatMsg(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_NotifyFileChatMsg() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status NotifyFileChatMsg(::grpc::ServerContext* /*context*/, const ::message::FileChatMsgReq* /*request*/, ::message::FileChatMsgRsp* /*response*/) override {
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_NotifyFileChatMsg : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_NotifyFileChatMsg() {
      ::grpc::Service::MarkMethodStreamed(5,
        new ::grpc::internal::StreamedUnaryHandler<
          ::message::FileChatMsgReq, ::message::FileChatMsgRsp>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::message::FileChatMsgReq, ::message::FileChatMsgRsp>* streamer) {
                       return this->StreamedNotifyFileChatMsg(context,
                         streamer);
                  }));
    }
    ~WithStreamedUnaryMethod_NotifyFileChatMsg() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status NotifyFileChatMsg(::grpc::ServerContext* /*context*/, const ::message::FileChatMsgReq* /*request*/, ::message::FileChatMsgRsp* /*response*/) override {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedNotifyFileChatMsg(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::message::FileChatMsgReq,::message::FileChatMsgRsp>* server_unary_streamer) = 0;
  };
  typedef WithStreamedUnaryMethod_NotifyAddFriend<WithStreamedUnaryMethod_RplyAddFriend<WithStreamedUnaryMethod_SendChatMsg<WithStreamedUnaryMethod_NotifyAuthFriend<WithStreamedUnaryMethod_NotifyTextChatMsg<WithStreamedUnaryMethod_NotifyFileChatMsg<Service > > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_NotifyAddFriend<WithStreamedUnaryMethod_RplyAddFriend<WithStreamedUnaryMethod_SendChatMsg<WithStreamedUnaryMethod_NotifyAuthFriend<WithStreamedUnaryMethod_NotifyTextChatMsg<WithStreamedUnaryMethod_NotifyFileChatMsg<Service > > > > > > StreamedService;
};
